...
class MaranathaBrandCard extends StatelessWidget {
  const MaranathaBrandCard({super.key});
                        ...
                        child: Row(
                          children: [
                            ...
                            MaranathaCircularImage(
                              ...
                              backgroundColor: Colors.transparent,
                              overlayColor: MaranathaHelperFunctions.isDarkMode(context) ? MaranathaColors.white : MaranathaColors.black,
                              ),
                              ...
                              Column(
                                ...
                                children: [
                                  const MaranathaBrandTitleTextWithVerifiedIcon(title: 'Nike', brandTextSize: TextSizes.large,),
                                  Text(
                                    '256 products',
