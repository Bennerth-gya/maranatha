...
class MaranathaTextTheme {
  MaranathaTextTheme._();
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    titleLarge: const TextStyle().copyWith(fontSize: 12.0, fontWeight: FontWeight.w600, color: Colors.black),
    ...
    labelSmall: const TextStyle().copyWith(fontSize: 12, fontWeight: FontWeight.normal, color: Colors.black.withOpacity(0.5))
  );
  static TextTheme darkTextTheme = TextTheme(
    ...
    titleLarge: const TextStyle().copyWith(fontSize: 12.0, fontWeight: FontWeight.w600, color: Colors.white),
